...
// 🔥 NEW: Import your large token set
import TOKENS from "./instrumentTokens.js";
...
// 🔥 NEW: AUTOGENERATED SYMBOL MAP (symbol1, symbol2, symbol3…)
const SYMBOLS = TOKENS.map((_, i) => `SYM${i+1}`);
